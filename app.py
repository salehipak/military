...
dmd_sample_data = pd.DataFrame(pd.ExcelFile('dmd_sample.xlsx')).sort_values('dmd_id')
prd_sample_data = pd.DataFrame(pd.ExcelFile('prd_sample.xlsx')).sort_values('prd_id')
